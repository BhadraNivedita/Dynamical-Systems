...
%attraction
clc;clear;tic;
k=1;e=0.3;r=11;q=5;p=0.5;lam=.001;kk=1;
...
s=pi;tt=0;
for i= 0.0:p*0.0125:2*pi
     for j=-1:p*0.05:1
        [~,xx]=ode45(Pendulum,[0 50*pi],[i,j,s,tt],options);
        M=mean(xx(end-5:end,1));
...
A=[ang;vel];
fileID=fopen('basinlam.001partial.txt','w');
